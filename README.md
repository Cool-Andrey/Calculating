...
### JWT присутствует в другой ветке, но не сделана документация. Дайте время до вечера, сделаю доки и запушу. Если дадите еще немного времени, то и тесты будут. Спасибо за понимание!
